...
<nav class="bg-gray-800 p-4">
    <div class="container mx-auto flex justify-between items-center">
        <a href="/adsDashboard" class="text-white font-bold text-lg">Home</a>
        ...
        <?php foreach ($posts as $post): ?>
            <div class="bg-white p-6 rounded-lg shadow-lg relative">
                <?php if(isset($post['image_path'])): ?>
                    <p class="text-gray-600 mb-4"><?php echo htmlspecialchars($post['image']); ?></p>
                    <img src="<?php echo htmlspecialchars(ltrim($post['image_path'])); ?>"  class="w-full h-48 object-cover mb-4" alt="Image">
                <?php endif; ?>
                <h2 class="text-lg font-bold text-gray-800 mb-2"><?php echo htmlspecialchars($post['title']); ?></h2>
