...
<div class="container mx-auto p-8">
    ...
    <form class="bg-white p-6 rounded-lg shadow-lg" action="/createAdsPage" method="post" enctype="multipart/form-data">
    ...
    <div class="container mx-auto mt-8">
        ...
        <div class="mb-4">
            ...
            <input type="file" id="image" name="image"  class="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring focus:border-blue-300">
        </div>
